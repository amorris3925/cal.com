...
# Branding. These are NEXT_PUBLIC_*, so they are read at build time and baked
# into the client bundle — setting them only as runtime env has no effect, which
# is why the app kept saying "Cal.com" after they were configured.
